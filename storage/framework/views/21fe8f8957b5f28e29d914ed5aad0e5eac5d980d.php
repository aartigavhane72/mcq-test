                        ...
                        <?php else: ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo e(route('studentlogout')); ?>"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form4').submit();">
                                            Logout
                                        </a>

                                        <form id="logout-form4" action="<?php echo e(route('studentlogout')); ?>" method="POST" style="display: none;">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        ...
                                        <a href="<?php echo e(url('studentlogout')); ?>"
                                            onclick="event.preventDefault();
                                                     document.getElementById('logout-form5').submit();">
                                            <i class="ti-layout-sidebar-left"></i> Logout
                                        </a>

                                        <form id="logout-form5" action="<?php echo e(url('studentlogout')); ?>" method="POST" style="display: none;">
                                            <?php echo e(csrf_field()); ?>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-40 img-radius" src="<?php echo e(asset('assets/images/avatar-4.jpg')); ?>" alt="User-Profile-Image">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        ...
                                        <form id="logout-form3" action="<?php echo e(url('studentlogout')); ?>" method="POST" style="display: none;">
                                            <?php echo e(csrf_field()); ?>
...
<script  type="text/javascript" src="<?php echo e(asset('assets/js/demo-12.js')); ?>"></script>
