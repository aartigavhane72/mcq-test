...
<a href="index.html">
<!--  <img class="img-fluid" src= '<?php echo e(Auth::user()->image); ?>' alt="Theme-Logo" />  -->
<?php echo e(Auth::user()->institution_name); ?>
...
<a href="<?php echo e(url('liststudent')); ?>">
...
<li class="pcoded-hasmenu">
<a href="<?php echo e(url('StudentResult')); ?>">
<span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
...
function detailResult($userid,$examcode) {
    $examcode = 1;
...
function DisplayQuestion($no , $id, $question, $A ,$B , $C , $D, $m , $co, $l ){
