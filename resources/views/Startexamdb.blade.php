                    ...
                    @endif
                        <div class="card">
                            ...
                            <div class="card-block ">
                                ...
                                <input type="hidden" id="negmarks{{$value->id}}" value="1">
                                <!-- End Radio Button -->
...
AddUserResponse($current_question_id , $('input[name=option'+$current_question_id+']:checked').val() );
...
var urlss = base_urls + '/adduserreponse';
