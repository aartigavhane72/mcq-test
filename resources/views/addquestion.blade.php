                                ...
                                <table class="table" id="table">
                                    ...
                                    @foreach ($question as $value)
                                        <tr class="student{{$value->id}}">
                                            ...
                                            <td class="text-success">{{ $value->category }} </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" onclick="DisplayQuestion('{{ $no-1 }}' , '{{ $value->id }}' , '{{ $newque }}' , '{{ ($option_A) }}' , '{{ $option_B }}' , '{{ $option_C }}' , '{{ $option_D }}' , '{{ $value->marks }}' , '{{ $value->correct_option }}' , '{{ $value->level }}')"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body"> 
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" id="modal_form_id"  method="POST">
                                        ...
                                        <input type="hidden" disabled class="form-control" id="category1" name="category1" value=" {{ $cat }}" placeholder="category1" required>
