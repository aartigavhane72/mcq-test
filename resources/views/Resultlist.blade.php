    ...
    <!-- End Create New Exam -->
            ...
            @foreach ($result as $value)
                ...
                ?>
                                    ...
                                    <td style="text-align: center;">{{$getCorrectAns}}</td>
                                    <td style="text-align: center;">{{$getWrongAns}}</td>
                                    <td>  <a href="{{url('getfulldetailmyresult/1', $userid)}}" class="btn-primary btn-sm"><i class="icofont icofont-eye-alt"></i></a>
                                      </td>
                                </tr>
                                </tbody>
                                </table>
